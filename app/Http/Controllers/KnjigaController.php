    ...
    */
    ...
    public function store(Request $request)
    {
        ...
        foreach ($zanri as $zanr):
           $knjiga->zanrovis()->attach($zanr);
        endforeach;
        foreach ($kategorije as $kategorija):
           $knjiga->kategorijes()->attach($kategorija);
        endforeach;
        if ($knjiga) {
    ...
    public function izdaj(Request $request,Knjiga $knjiga){
        ...
        $datumVracanja=explode('/',$request->datumVracanja);
         ...
         $izdavanje=Izdavanje::create([
          'knjiga_id'=>$knjiga->id,
          'izdaokorisnik_id'=>auth()->user()->id,  //$request->izdao  auth()->user()->id
    ...
    public function rezervisi(Request $request, Knjiga $knjiga){
     $request->validate([
      ...
      'knjiga_id'=>$knjiga->id,
      'rezervisaokorisnik_id'=>auth()->user()->id,                  //$request->izdao,
