@if($tip == 3)
                <div class="w-full mt-[10px] ml-2 px-2">
                            <table class="w-full shadow-lg" id="myTable">
                                ...
                                @php $daysTotal = \Carbon\Carbon::parse($izdavanje[$brojac]->datumizdavanja)->diffInDays();@endphp
                                
                                @if ($statusiKnjiga[$brojac]->statusknjige_id== 2 && $daysTotal>30)
                                    <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                                        ...
                                        <div  class='px-4 py-3 text-sm leading-5 whitespace-no-wrap bg-red-200 rounded-[10px]' >
                                        ...
                                        <td class="px-6 py-3 text-sm leading-5 text-right whitespace-no-wrap">
                                            ...
                                            <div
                                                ...
                                                <div class="absolute right-0 w-56 mt-2 origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                                                    ...
                                                    <div class="py-1">
                                                        <a href="{{route('evidencija.showPrekoracenje',$izdavanje[$brojac])}}" tabindex="0"
