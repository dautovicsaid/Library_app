  ...
  <section class="w-screen h-screen pl-[80px] pb-2 text-gray-700">
            ...
            <div class="heading">
                <div class="flex flex-row justify-between border-b-[1px] border-[#e4dfdf]">
                            ...
                            <div>
                                <nav class="w-full rounded">
                                    <ol class="flex list-reset">
                                        <li>
                                            <a href="{{route('evidencija.index')}}p" class="text-[#2196f3] hover:text-blue-600">
                                                Evidencija knjiga
                                            </a>
                                        </li>
                                        <li>
                    ...
                    <div class="pt-[24px] mr-[30px]">
                        ...
                        <a href="{{route('knjiga.vracanje')}}" class="hover:text-blue-600 inline ml-[20px] pr-[10px]">
                            <i class="fas fa-redo-alt mr-[3px] "></i>
                            Vrati knjigu

                        </a>
                        <a href="{{route('knjiga.rezervisanje' , $knjiga->id)}}" class="hover:text-blue-600 inline ml-[20px] pr-[10px]">
                        ...
                        <div class="flex flex-row justify-between">
                            <div class="mr-[30px]">
                                ...
                                <div class="mt-[40px]">
                                    ...
                                    <p class="font-medium">{{$izdavanje->datumizdavanja}}</p>
                                </div>
                                <div class="mt-[40px]">
                                ...
                                <div class="mt-[40px]">
                                    ...
                                    <a href="bibliotekarProfile.php"
                                        class="block font-medium text-[#2196f3] hover:text-blue-600">{{$bibliotekar}}</a>
                                </div>
                                <div class="mt-[40px]">
                                    <span class="text-gray-500">Ucenik</span>
                                    <a href="ucenikProfile.php"
                                        class="block font-medium text-[#2196f3] hover:text-blue-600">{{$ucenik}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div
        ...
        <div class="w-[500px] bg-white rounded shadow-lg md:w-1/3">
            ...
            <div class="flex items-center justify-between px-[30px] py-[20px] border-b">
                <h3>Da li zelite da vratite knjigu {{$knjiga->Naslov}}" za ucenika </h3>
            </div>
            <!-- Modal Body -->
            <div class="flex items-center justify-end px-[30px] py-[20px] border-t w-100 text-white">
            <form action="{{route('knjiga.vrati' , $knjiga->id)}}"  method="post">
            @csrf
                <button type="button"
    ...
    <div
        ...
        <div class="w-[500px] bg-white rounded shadow-lg md:w-1/3">
            ...
            <!-- Modal Body -->
            <div class="flex items-center justify-end px-[30px] py-[20px] border-t w-100 text-white">
            <form action="{{route('knjiga.otpisi', $knjiga)}}"  method="post">
            @csrf
                <button type="button"
                    class="close-modal shadow-lg mr-[15px] w-[150px] focus:outline-none text-sm py-2.5 px-5 transition duration-300 ease-in bg-[#F44336] hover:bg-[#F55549] rounded-[5px]">
                    Ponisti <i class="fas fa-times ml-[4px]"></i>
