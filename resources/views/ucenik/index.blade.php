...
<section class="w-screen h-screen py-4 pl-[80px] text-[#333333]">
            ...
            <div class="scroll height-dashboard">
                <div class="flex items-center justify-between px-[30px] py-4 space-x-3 rounded-lg">
                    <a href="{{route('ucenik.create')}}" class="btn-animation inline-flex items-center text-sm py-2.5 px-5 rounded-[5px] tracking-wider text-white bg-[#3f51b5] rounded hover:bg-[#4558BE]">
                        ...
                        @foreach($ucenici as $u)
                            <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                                ...
                                <td class="flex flex-row items-center px-4 py-4">
                                    <img class="object-cover w-8 h-8 mr-2 rounded-full" src="@if($u->Foto){{ asset('/storage' . $u->Foto) }}@else /img/defaultusericon.jpg @endif" alt="" />
                                    <a href="{{route('ucenik.show',$u->id)}}">
                                        <span class="font-medium text-center">{{$u->ImePrezime}}</span>
                                    </a>
                                </td>
                                <td class="px-4 py-4 text-sm leading-5 whitespace-no-wrap">{{$u->email}}
                                </td>
            ...
            <form class="forma" method="post" action="{{ route('reset.sifre', $u) }}" >
                ...
                <div class="flex flex-col px-[30px] py-[30px]">
                    <div class="flex flex-col pb-[30px]">
                        ...
                        <div id="validBibatePwResetUcenik"></div>
                    </div>
                    <div class="flex flex-col pb-[30px]">
