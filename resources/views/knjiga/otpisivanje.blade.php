            ...
            <div class="scroll height-dashboard px-[30px]">
                ...
                <div
                    ...
                    <table class="min-w-full shadow-lg" id="vratiKnjiguTable">
                        ...
                        <form method="post" action="{{route('knjiga.otpisi',$knjiga)}}" class="text-gray-700 forma">
                        @csrf 
                        @method('POST')
                        @foreach($izdate as $i)
                            <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                                <td class="px-4 py-4 whitespace-no-wrap">
                                    <label class="inline-flex items-center">
                                        <input value="{{$i->izdavanje_id}}" name="vrati[]" type="checkbox" class="form-checkbox">
                                    </label>
                                </td>
                                <td class="flex flex-row items-center px-4 py-4">
                                    ...
                                    <a href="ucenikProfile.php">
                                        <span class="font-medium text-center">{{$i->izdato_za($i->izdavanje_id)[0]->ImePrezime}}</span>
                                    </a>
                                </td>
