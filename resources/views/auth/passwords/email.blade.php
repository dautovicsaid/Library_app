    ...
    <main class="h-screen small:hidden bg-login">
        <div class="flex items-center justify-center pt-[13%]">
            <div class="w-full max-w-md">
                ...
                <form method="POST" action="{{ route('password.email') }}" class="px-12 pt-6 pb-4 mb-4 bg-white rounded shadow-lg" >
                     @csrf 
                    ...
                    <div class="mb-6">
                        ...
                        <input
                            ...
                            name="email" required autocomplete="current-password" placeholder="Password" 
                            id="email" type="email"/>
                            @error('email')
