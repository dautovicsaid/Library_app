            ...
            <div class="block">
                <a href="/dashboard" class="text-[20px] font-medium">
                    <div class="flex">
                        ...
                        <p class="text-[20px] mt-[5px]">&nbsp;&nbsp;Speedy Slavica</p>
                    </div>
            ...
            <div class="flex items-center">
                    ...
                    <a href="#" class="relative inline-block px-3 py-2 focus:outline-none" id="dropdownProfile"
                        ...
                        <div class="flex items-center h-5">
                            <div class="w-[40px] h-[40px] mt-[15px]">
                                 <img class="rounded-full" src="@if( Auth::user()->Foto) {{ asset('/storage' . Auth::user()->Foto)}} @else img/defaultusericon.jpg @endif" alt="">  
                            </div>
                        </div>
                    </a>
                </div>
                <div
                    ...
                    <div class="absolute right-[12px] w-56 mt-[35px] origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                       ...
                       <div class="py-1">
                            <a href="
                        @if(Auth::user()->tipkorisnika_id == 2) 
